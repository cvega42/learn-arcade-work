...
laser_sound = arcade.load_sound("arcade_resources_sounds_laser4.wav")
hit_sound = arcade.load_sound("arcade_resources_sounds_explosion2.wav")
enemy_sound = arcade.load_sound("arcade_resources_sounds_laser5.wav")
